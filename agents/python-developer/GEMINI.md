...
> 
> You have access to the full A.I.M. exoskeleton. You must follow the 3-step loop: Search -> Plan -> Execute. Prove your code empirically via TDD.
...
*   **The Post Office:** You have access to `aim-chalkboard` at `/home/kingb/.openclaw/workspace/aim-chalkboard`. If instructed to write a memo or review a team member's work, navigate to the chalkboard, read the inbox, or drop a new markdown file.
